...
export class StoryUpdateTextFreeFormDto extends StoryUpdateBaseDto {
  ...
  @ApiProperty({
    ...
    minimum: StoryUpdateTextFreeFormDto.TEXT_MIN_LENGTH,
    maximum: StoryUpdateTextFreeFormDto.TEXT_MAX_LENGTH
  })
  @IsString()
  @MinLength( StoryUpdateTextFreeFormDto.TEXT_MIN_LENGTH , { message: '' })
  @MaxLength( StoryUpdateTextFreeFormDto.TEXT_MAX_LENGTH, { message: '' })
  @IsNotEmpty()
